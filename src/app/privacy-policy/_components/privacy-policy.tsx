    ...
    return (
        <div className="max-w-3xl mx-auto p-6 font-sans text-gray-800">
            ...
            <ul className="list-disc list-inside mb-4">
                ...
                <li>
                    <strong>Application</strong> refers to ChargeAway, the software program provided by the Company.
                </li>
                <li>
                    <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to ChargeAway, 621 Hawthorn Road, Brighton East 3187.
                </li>
                <li>
                ...
                <li>
                    <strong>Website</strong> refers to ChargeAway, accessible from <a className="text-blue-600 underline" href="https://chargeaway.com.au/" target="_blank" rel="noopener noreferrer">https://chargeaway.com.au/</a>
                </li>
                <li>
            ...
            <p className="mb-4">
                ...
                <a className="text-blue-600 underline" href="https://www.privacypolicygenerator.info/blog/cookies/" target="_blank" rel="noopener noreferrer"> Cookie Policy</a>.
            </p>
            ...
            <ul className="list-disc list-inside mb-4">
                ...
                <li>
                    <strong>To provide You with news, special offers, and general information about other goods, services, and events which we offer that are similar to those that you have already purchased or in
                        or enquired about unless You have opted not to receive such information.</strong></li>
            ...
            <h4 className="font-semibold mt-4 mb-2">Other legal requirements</h4>
            <p className="mb-4">
            ...
            <ul className="list-disc list-inside mb-4">
                <li>By email: <a className="text-blue-600 underline" href="mailto:contact@chargeaway.com.au">contact@chargeaway.com.au</a></li>
            </ul>
