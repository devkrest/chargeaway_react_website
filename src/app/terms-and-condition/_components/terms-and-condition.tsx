    ...
    return (
        <div className="max-w-3xl mx-auto p-6 font-sans text-gray-800">
            ...
            <p className="mb-4">
                ...
                &nbsp;<span className="font-bold">ChargeAway</span>'s Website, located at&nbsp;
                <a href="https://chargeaway.com.au" className="text-blue-600 hover:underline">https://chargeaway.com.au</a>.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
                ...
                of the Company’s stated services, in accordance with and subject to, prevailing law of Netherlands.
            ...
            <p className="mb-4">
                ...
                <span className="font-bold">&nbsp;ChargeAway</span>'s Privacy Policy.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
                Unless otherwise stated, <span className="font-bold">ChargeAway</span> and/or its licensors own the intellectual property rights for all material on&nbsp;
                <a href="https://chargeaway.com.au" className="text-blue-600 hover:underline">https://chargeaway.com.au</a>.
            ...
            <ul className="list-disc list-inside mb-4">
                <li>Republish material from <a href="https://chargeaway.com.au" className="text-blue-600 hover:underline">https://chargeaway.com.au</a></li>
                <li>Sell, rent or sub-license material from <a href="https://chargeaway.com.au" className="text-blue-600 hover:underline">https://chargeaway.com.au</a></li>
                <li>Reproduce, duplicate or copy material from <a href="https://chargeaway.com.au" className="text-blue-600 hover:underline">https://chargeaway.com.au</a></li>
                <li>Redistribute content from <a href="https://chargeaway.com.au" className="text-blue-600 hover:underline">https://chargeaway.com.au</a></li>
            </ul>
            ...
            <p className="mb-4">
                ...
                <span className="font-bold">ChargeAway</span> does not filter, edit, publish or review Comments prior to their presence on the website.
                Comments do not reflect the views and opinions of <span className="font-bold">ChargeAway</span>, its agents and/or affiliates.
                Comments reflect the views and opinions of the person who post their views and opinions.
                To the extent permitted by applicable laws, <span className="font-bold">ChargeAway</span> shall not be liable for the Comments or for any liability,
            ...
            <p className="mb-4">
                <span className="font-bold">ChargeAway</span> reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate,
            ...
            <p className="mb-4">
                You hereby grant <span className="font-bold">ChargeAway</span> a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit
            ...
            <ul className="list-disc list-inside mb-4">
                ...
                <li>the benefit to us from the visibility of the hyperlink compensates the absence of <span className="font-bold">ChargeAway</span>;</li>
            ...
            <p className="mb-4">
                ...
                <span className="font-bold">ChargeAway</span>. Please include your name, your organization name, contact information as well

                as the URL of your site,
            ...
            <p className="mb-4">
                No use of
                <span className="font-bold">ChargeAway</span>'s logo or other artwork will be allowed for linking absent a trademark license agreement.
            </p>

            <h3 className="text-xl font-semibold mt-6 mb-2">iFrames</h3>
            <p className="mb-4">
